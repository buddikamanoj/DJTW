...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tweet.analyzed_by'
        db.delete_column(u'twitter_stream_tweet', 'analyzed_by')


    def backwards(self, orm):
        # Adding field 'Tweet.analyzed_by'
        db.add_column(u'twitter_stream_tweet', 'analyzed_by',
