...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ApiKey.name'
        db.rename_column(u'twitter_stream_apikey', 'name', 'user_name')

        # Adding field 'ApiKey.app_name'
        db.add_column(u'twitter_stream_apikey', 'app_name',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ApiKey.user_name'
        db.rename_column(u'twitter_stream_apikey', 'user_name', 'name')

        # Deleting field 'ApiKey.app_name'
        db.delete_column(u'twitter_stream_apikey', 'app_name')
