...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StreamProcess.memory_usage'
        db.add_column(u'twitter_stream_streamprocess', 'memory_usage',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StreamProcess.memory_usage'
        db.delete_column(u'twitter_stream_streamprocess', 'memory_usage')
